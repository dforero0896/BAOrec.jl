...
if __name__ == '__main__':
    ...
    fig.savefig("/home/astro/dforero/codes/BAOrec/examples/lightcone_mg.png")

   

    data = np.load("/home/astro/dforero/codes/BAOrec/data/MG_CPU_Patchy-Mocks-DR12NGC-COMPSAM_V6C_0001.dat.rec.npy").astype(np.double)
    rand = np.load("/home/astro/dforero/codes/BAOrec/data/MG_CPU_Patchy-Mocks-Randoms-DR12NGC-COMPSAM_V6C_x20.dat.rec.iso.npy").astype(np.double)
    ...
    rand = np.load("/home/astro/dforero/codes/BAOrec/data/MG_CPU_Patchy-Mocks-Randoms-DR12NGC-COMPSAM_V6C_x20.dat.rec.sym.npy").astype(np.double)
    fkp_data = 1. / (1 + data[:,4] * P0)
    fkp_rand = 1. / (1 + rand[:,4] * P0)
