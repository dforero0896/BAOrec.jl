...
println("Weights")
data_cat_w = cu(fkp_weights.(data_cat[!,:nz], Ref(P0)))
rand_cat_w = cu(fkp_weights.(rand_cat[!,:nz], Ref(P0)))
println("Struct")
...
npzwrite("data/GPU_UNIT_lightcone_multibox_ELG_footprint_nz_NGC.rec.npy", hcat(new_pos', values(data_cat[!,:nz])))
npzwrite("data/GPU_UNIT_lightcone_multibox_ELG_footprint_nz_1xdata_5.ran_NGC.rec.sym.npy", hcat(new_rand_cat_sym', values(rand_cat[!,:nz])))
npzwrite("data/GPU_UNIT_lightcone_multibox_ELG_footprint_nz_1xdata_5.ran_NGC.rec.iso.npy", hcat(new_rand_cat_iso', values(rand_cat[!,:nz])))
...
npzwrite("data/MG_GPU_UNIT_lightcone_multibox_ELG_footprint_nz_NGC.rec.npy", hcat(new_pos', values(data_cat[!,:nz])))
npzwrite("data/MG_GPU_UNIT_lightcone_multibox_ELG_footprint_nz_1xdata_5.ran_NGC.rec.sym.npy", hcat(new_rand_cat_sym', values(rand_cat[!,:nz])))
npzwrite("data/MG_GPU_UNIT_lightcone_multibox_ELG_footprint_nz_1xdata_5.ran_NGC.rec.iso.npy", hcat(new_rand_cat_iso', values(rand_cat[!,:nz])))